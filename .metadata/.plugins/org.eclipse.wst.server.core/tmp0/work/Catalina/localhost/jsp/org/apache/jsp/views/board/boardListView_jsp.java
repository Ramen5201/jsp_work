 ...
 * Generated at: 2023-10-23 01:17:49 UTC
...
public final class boardListView_jsp extends org.apache.jasper.runtime.HttpJspBase
 ...
 if (loginUser != null) {
      out.write("\r\n");
      out.write("        <!-- 로그인한 회원보이게 -->\r\n");
      out.write("        <div align=\"right\" style=\"width: 850px;\">\r\n");
      out.write("            <a href=\"");
      out.print(contextPath );
      out.write("/enrollForm.bo\" class=\"btn btn-sm btn-secondary\">글작성</a>\r\n");
      out.write("            <br><br>\r\n");
      out.write("        </div>\r\n");
      out.write("        ");
 } 
 ...
 for(Board b : list ) { 
      ...
      out.write("        			// $(this) => 클릭된 객체를 가르킨다.\r\n");
      out.write("        			// 객체.children() => 객체의 자식노드List을 전부 가져온다.\r\n");
      out.write("        			// 노드List.eq(index) => 노드 list에서 해당 index의 값을 가져온다.\r\n");
      out.write("        			// text() => 그냥 메소드를 호출하면 텍스를 반호나하고 내부에 값을 전달하면 값이 들어간다.\r\n");
      out.write("        			\r\n");
      out.write("        			location.href = \"");
      out.print(contextPath);
