 ...
 * Generated at: 2023-10-25 09:23:27 UTC
...
public final class boardDetailView_jsp extends org.apache.jasper.runtime.HttpJspBase
 ...
 if(loginUser == null) { 
      ...
      out.write("        <br>\r\n");
      out.write("\r\n");
      out.write("        <table id=\"detail-area\" border=\"1\" align=\"center\">\r\n");
      out.write("            <tr>\r\n");
...
if (at == null) {
      out.write("\r\n");
      out.write("                    <!-- case1 첨부파일이 없을 경우 -->\r\n");
      out.write("                    첨부파일이 없습니다.\r\n");
      out.write("                ");
 } else { 
      out.write("\r\n");
      out.write("                    <!-- case2 첨부파일이 있을 경우 -->\r\n");
      ...
      out.write("            <a href=\"");
      out.print(contextPath );
      out.write("/list.bo?cpage=1\" class=\"btn btn-sm btn-secondary\">목록가기</a>\r\n");
      out.write("			");
if (loginUser != null && loginUser.getUserId().equals(b.getBoardWriter())) { 
      out.write("\r\n");
      out.write("            <!-- 로그인한 사용자가 게시글의 작성자일 경우 사용가능 -->\r\n");
      out.write("            <a href=\"");
      out.print(contextPath );
...
if (loginUser != null) { 
      out.write("\r\n");
      out.write("	                    <td>\r\n");
      out.write("	                        <textarea id=\"reply-content\" cols=\"50\" rows=\"3\"></textarea>\r\n");
      out.write("	                    </td>\r\n");
      out.write("	                    <td>\r\n");
      ...
      out.write("\r\n");
      out.write("	                    <td>\r\n");
      out.write("	                        <textarea id=\"reply-content\" cols=\"50\" rows=\"3\" readonly>로그인 후 댓글작성 가능합니다.</textarea>\r\n");
      out.write("	                    </td>\r\n");
      out.write("	                    <td>\r\n");
      ...
      out.write("            		// 댓글 가져와서 그려주기\r\n");
      out.write("            		selectReplyList();\r\n");
      out.write("            		\r\n");
      out.write("            		setInterval(selectReplyList,2000)\r\n");
      out.write("            	}\r\n");
      out.write("            	\r\n");
      ...
      out.write("            				let str = \"\";\r\n");
      out.write("            				for (let reply of res) {\r\n");
      ...
      out.write("            				}\r\n");
      out.write("            				\r\n");
      out.write("            				document.querySelector(\"#reply-area tbody\").innerHTML = str;\r\n");
      out.write("            				\r\n");
      out.write("            				\r\n");
      out.write("            			},\r\n");
      out.write("            			error: function(){\r\n");
      out.write("            				console.log(\"댓글목록 조회중 ajax통신실패\");\r\n");
      out.write("            			}\r\n");
      out.write("            		})\r\n");
      out.write("            	}\r\n");
      out.write("            	\r\n");
      ...
      out.write("                        data : {\r\n");
      out.write("                            content: document.querySelector(\"#reply-content\").value,\r\n");
      out.write("                            bno: ");
      out.print(b.getBoardNo());
      out.write("\r\n");
      out.write("                        },\r\n");
      out.write("                        type:\"post\",\r\n");
      out.write("                        success:function(res){\r\n");
      out.write("                            if(res > 0) { // 댓글작성 성공\r\n");
      out.write("                            	document.querySelector(\"#reply-content\").value = \"\";\r\n");
      out.write("                            	selectReplyList();\r\n");
      out.write("                            }\r\n");
      out.write("                        },\r\n");
      out.write("                        error:function(){\r\n");
      out.write("							console.log(\"댓글 작성중 ajax통신 실패\")\r\n");
      out.write("                        }\r\n");
      out.write("                    })\r\n");
      out.write("                }\r\n");
      out.write("            </script>\r\n");
