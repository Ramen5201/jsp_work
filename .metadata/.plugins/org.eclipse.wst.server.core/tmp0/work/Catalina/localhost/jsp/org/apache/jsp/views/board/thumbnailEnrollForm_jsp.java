 ...
 * Generated at: 2023-10-24 05:13:47 UTC
...
public final class thumbnailEnrollForm_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  static {
    ...
    _jspx_dependants.put("/views/board/../common/menubar.jsp", Long.valueOf(1698110865774L));
  }
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
    ...
    try {
      ...
      out.write("    }\r\n");
      out.write("    #enroll-form img:hover{\r\n");
 ...
 if(loginUser == null) { 
      ...
      out.write("                    <th>내용</th>\r\n");
      out.write("                    <td colspan=\"3\">\r\n");
      out.write("                        <textarea name=\"content\" rows=\"5\" required style=\"resize: none;\"></textarea>\r\n");
      out.write("                    </td>\r\n");
      out.write("                </tr>\r\n");
      out.write("                <tr>\r\n");
      out.write("                    <th>대표이미지</th>\r\n");
      out.write("                    <td colspan=\"3\">\r\n");
      out.write("                        <img id=\"title-img\" width=\"250\" height=\"170\" onclick=\"chooseFile(1)\">\r\n");
      out.write("                    </td>\r\n");
      out.write("                </tr>\r\n");
      out.write("                <tr>\r\n");
      out.write("                    <th>상세이미지</th>\r\n");
      out.write("                    <td><img id=\"content-img1\" width=\"150\" height=\"120\" onclick=\"chooseFile(2)\"></td>\r\n");
      out.write("                    <td><img id=\"content-img2\" width=\"150\" height=\"120\" onclick=\"chooseFile(3)\"></td>\r\n");
      out.write("                    <td><img id=\"content-img3\" width=\"150\" height=\"120\" onclick=\"chooseFile(4)\"></td>\r\n");
      out.write("                </tr>\r\n");
      out.write("            </table>\r\n");
      out.write("            \r\n");
      ...
      out.write("                // num : 몇번째 input 요소인지 확인하기 위한 파라미터\r\n");
      out.write("                \r\n");
      out.write("                // inputFile.files[0]에 선택된 파일이 담겨 있을 것 이다.\r\n");
      out.write("                // inputFile.files.length => 1일 것이다.\r\n");
      out.write("                \r\n");
      out.write("                if(inputFile.files.length == 1) { // 파일이 선택된 경우 => 미리보기 나타나게\r\n");
      out.write("                	// 파일을 읽어들일 FileReader객체 생성\r\n");
      out.write("                	const reader = new FileReader();\r\n");
      out.write("                \r\n");
      out.write("                	// 파일을 읽어들이는 메소드\r\n");
      out.write("                	// 해당파일을 읽어들이는 순간 해당 파일만의 고유한 url부여\r\n");
      out.write("                	reader.readAsDataURL(inputFile.files[0]);\r\n");
      out.write("                	\r\n");
      out.write("                	// 파일 읽어들이기 완료했을 때 실행할 함수 정의\r\n");
      out.write("                	reader.onload = function(ev) {\r\n");
      out.write("                		// ev.target.result => 읽어들인 파일의 고유한 url\r\n");
      out.write("                		switch(num) {\r\n");
      out.write("                			case 1: document.getElementById('title-img').src = ev.target.result; break;\r\n");
      out.write("                			case 2: document.getElementById('content-img1').src = ev.target.result; break;\r\n");
      out.write("                			case 3: $(\"#content-img2\").attr(\"src\", ev.target.result); break;\r\n");
      out.write("                			case 4: $(\"#content-img3\").attr(\"src\", ev.target.result); break;\r\n");
      out.write("                		}\r\n");
      out.write("                	}\r\n");
      out.write("                	\r\n");
      out.write("                } else { // 선택된 파일이 취소된 경우 => 미리보기 사라지게\r\n");
      out.write("                	switch(num) {\r\n");
      out.write("        				case 1: document.getElementById('title-img').src = null; break;\r\n");
      out.write("        				case 2: document.getElementById('content-img1').src = null; break;\r\n");
      out.write("        				case 3: $(\"#content-img2\").attr(\"src\", null); break;\r\n");
      out.write("        				case 4: $(\"#content-img3\").attr(\"src\", null); break;\r\n");
      out.write("        		}\r\n");
      out.write("                }\r\n");
      out.write("            }\r\n");
      out.write("\r\n");
