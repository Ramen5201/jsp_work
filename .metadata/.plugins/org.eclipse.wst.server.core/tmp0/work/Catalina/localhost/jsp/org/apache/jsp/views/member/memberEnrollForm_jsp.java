 ...
 * Generated at: 2023-10-25 03:50:14 UTC
...
public final class memberEnrollForm_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  static {
    ...
    _jspx_dependants.put("/views/member/../common/menubar.jsp", Long.valueOf(1698110865774L));
  }
 ...
 if(loginUser == null) { 
      ...
      out.write("\r\n");
      out.write("            <div align = \"center\">\r\n");
      out.write("                <button type=\"submit\" disabled onclick=\"return checkPwd();\">회원가입</button>\r\n");
      ...
      out.write("            	\r\n");
      out.write("                let updatePwd = document.querySelector(\"#enroll-form input[name=updatePwd]\");\r\n");
      out.write("                let checkPwd = document.querySelector(\"#enroll-form input[name=checkPwd]\");\r\n");
      out.write("                if (updatePwd.value !== checkPwd.value) {\r\n");
      ...
      out.write("                // 중복확인 버튼 클릭시 사용자가 입력한 아이디값을 서버에 보내서 조회요청(존재하는지 안하는지) => 응답데이터 돌려받기\r\n");
      out.write("                // 1) 사용불가능일 경우 => alert로 메세지 출력, 다시 입력할 수 있도록 유도\r\n");
      out.write("                // 2) 사용가능한 경우 => 진짜 사용할건지 의사 물어봄 \r\n");
      out.write("                //                       > 사용하겠다는 경우 => 더이상 아이디 수정 못하게끔, 회원가입버튼 활성\r\n");
      out.write("                //                       > 사용하지않겠다는 경우 => 다시 입력 할 수 있도록 유도\r\n");
      out.write("\r\n");
      out.write("                const idInput = document.querySelector(\"#enroll-form input[name=userId]\");\r\n");
      out.write("                console.log(idInput.value);\r\n");
      out.write("\r\n");
      out.write("                $.ajax({\r\n");
      ...
      out.write("								let submitBtn = document.querySelector(\"#enroll-form button[type=submit]\");\r\n");
      ...
      out.write("							}\r\n");
      out.write("						} else {\r\n");
      out.write("							alert(\"이미 존재하거나 탈퇴한 회원입니다.\");\r\n");
      out.write("							idInput.focus();\r\n");
      out.write("						}\r\n");
      out.write("                    },\r\n");
      out.write("                    error: function(){\r\n");
      out.write("                        console.log(\"아이디 중복체크용 ajax통신실패\");\r\n");
      out.write("                    }\r\n");
      out.write("                })\r\n");
      out.write("            }\r\n");
      out.write("        </script>\r\n");
