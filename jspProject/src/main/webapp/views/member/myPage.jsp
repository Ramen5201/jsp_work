	...
	<div class="outer">
		...
		<form action="" id="mypage-form" method="post">
			<table>
				...
				<tr>
					<td>관심분야</td>
					<td colspan="2"><input type="checkbox" name="interest" id="sports" value="운동"> 
			...
			<div align="center">
				...
				<button type="button"  class="btn btn-sm btn-warning"data-bs-toggle="modal"
					data-bs-target="#updatePwdModal">비밀번호변경</button>
				<button type="button" data-bs-toggle="modal"
					data-bs-target="#deleteModal" class="btn btn-sm btn-danger">회원탈퇴</button>
			</div>
			...
			<div class="modal-content">
				...
				<div class="modal-body" align="center">
					<form action="<%=contextPath%>/updatePwd.me" method="post">
						...
						<br>
						<button id="eidt-pwd-btn" type="submit"
							class="btn btn-sm btn-secondary">비밀번호 변경</button>
					</form>

					<script>
	                	document.getElementById('eidt-pwd-btn').onclick=function(){
			...
			<div class="modal-content">
				...
				<div class="modal-body" align="center">
					<form action="<%=contextPath %>/delete.me" method="post">
						<b>탈퇴후 복구가 불가능 합니다. <br> 정말로 탈퇴하시겠습니까?
						</b> <br> <br> <input type="hidden" name="userId"
							value="<%=userId %>"> 비밀번호 : <input type="password"
